...
def train_eval(
    ...
    with tf.compat.v2.summary.record_if(
        ...
        # JAG: critic_net is the classifier
        ...
        # JAG: We need to change collect_policy of the code
        ...
        # JAG: Use collect_driver to collect env steps from the environment
        ...
        # JAG: Train by num_iterations timesteps
        while global_step_val < num_iterations:
            ...
            if global_step_val % log_interval == 0:
                ...
                env_steps_per_sec = (global_step_val - timed_at_step) \
                        / env_time_acc
                logging.info('Env: %.3f steps/sec', env_steps_per_sec)
                tf.compat.v2.summary.scalar(
                        name='env_steps_per_sec',
                        data=env_steps_per_sec, step=global_step)
